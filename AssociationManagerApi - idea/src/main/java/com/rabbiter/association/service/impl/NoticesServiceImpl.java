...
public class NoticesServiceImpl implements NoticesService {
    ...
    public PageData getPageAll(Long pageIndex, Long pageSize, String title, String teamName, String teamId, Integer systemOnly){
        ...
        Page<Map<String, Object>>  page =
                noticesDao.qryPageAll(new Page<Map<String, Object>>(pageIndex, pageSize), title, teamName, teamId, systemOnly);
    ...
    public PageData getPageById(Long pageIndex, Long pageSize, String userId, String title, String teamName, String teamId, Integer systemOnly){
        ...
        Page<Map<String, Object>>  page =
                noticesDao.qryPageById(new Page<Map<String, Object>>(pageIndex, pageSize), userId, title, teamName, teamId, systemOnly);
    ...
    public PageData getPageByMemberId(Long pageIndex, Long pageSize, String userId, String title, String teamName, String teamId, Integer systemOnly){
        ...
        Page<Map<String, Object>>  page =
                noticesDao.qryPageByMemberId(new Page<Map<String, Object>>(pageIndex, pageSize), userId, title, teamName, teamId, systemOnly);
    ...
    public List<Map<String, Object>> parseList(List<Notices> notices){
        ...
        for (Notices notice : notices) {
            ...
            temp.put("isTop", notice.getIsTop());
