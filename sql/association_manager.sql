...
('1689249023967', '2023-07-14 09:30:00', 40, '1689228337876', '1689228092884'),
('1689249023968', '2023-07-15 11:20:00', 60, '1689228337876', '1689228092884');

-- Table structure for pay_expenses
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消费明细' ROW_FORMAT = Dynamic;

-- Records of pay_expenses
INSERT INTO `pay_expenses` VALUES ('1689259023966', '2023-07-15 10:00:00', 80, '海报设计', '社团招新海报与展板打印', '1689228337876', '1689228092884');
...
CREATE TABLE `rules`  (
  `id` char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `title` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_time` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `update_time` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `team_id` char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `user_id` char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_rules_team`(`team_id`) USING BTREE,
  INDEX `idx_rules_user`(`user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

INSERT INTO `rules` VALUES ('1689251000001', '社团活动安全规范', '参加活动需遵守现场秩序与安全要求。', '2023-07-14 08:00:00', '2023-07-14 08:00:00', NULL, '1689228116467');
INSERT INTO `rules` VALUES ('1689251000002', '计算机协会入会规则', '本社团每周参与至少一次例会。', '2023-07-14 09:00:00', '2023-07-14 09:00:00', '1689228337876', '1689228178877');
...
CREATE TABLE `interactions`  (
  ...
  `user_id` char(13) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_interactions_team`(`team_id`) USING BTREE,
  INDEX `idx_interactions_user`(`user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

INSERT INTO `interactions` VALUES ('1689252000001', '本周活动讨论', '欢迎大家在这里交流本周活动安排。', '2023-07-14 10:00:00', NULL, '1689228116467');
INSERT INTO `interactions` VALUES ('1689252000002', '协会技术分享建议', '我建议下周分享主题为前端工程化。', '2023-07-14 10:30:00', '1689228337876', '1689228092884');
